...
pub mod roles_component {
    ...
    > of IRoles<ComponentState<TContractState>> {
        fn is_app_governor(self: @ComponentState<TContractState>, account: ContractAddress) -> bool {
            get_dep_component!(self, Access).has_role(role: APP_GOVERNOR, :account)
        }

        fn is_app_role_admin(self: @ComponentState<TContractState>, account: ContractAddress) -> bool {
            let access_comp = get_dep_component!(self, Access);
            access_comp.has_role(role: APP_ROLE_ADMIN, :account)
        }

        fn is_governance_admin(self: @ComponentState<TContractState>, account: ContractAddress) -> bool {
            let access_comp = get_dep_component!(self, Access);
        ...
        fn is_security_admin(self: @ComponentState<TContractState>, account: ContractAddress) -> bool {
            let access_comp = get_dep_component!(self, Access);
            access_comp.has_role(role: SECURITY_ADMIN, :account)
        }

        fn is_security_agent(self: @ComponentState<TContractState>, account: ContractAddress) -> bool {
            let access_comp = get_dep_component!(self, Access);
        ...
        fn is_upgrade_governor(self: @ComponentState<TContractState>, account: ContractAddress) -> bool {
            let access_comp = get_dep_component!(self, Access);
            access_comp.has_role(role: UPGRADE_GOVERNOR, :account)
        }

        fn register_app_governor(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn register_app_role_admin(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn remove_app_role_admin(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn register_security_admin(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn remove_security_admin(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn register_security_agent(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn remove_security_agent(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn register_governance_admin(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn remove_governance_admin(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn register_token_admin(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn register_upgrade_governor(ref self: ComponentState<TContractState>, account: ContractAddress) {
        ...
        fn remove_upgrade_governor(ref self: ComponentState<TContractState>, account: ContractAddress) {
    ...
    > of InternalTrait<TContractState> {
        ...
        fn _grant_role_and_emit(
            ref self: ComponentState<TContractState>, role: RoleId, account: ContractAddress, event: Event
        ) {
            let mut access_comp = get_dep_component_mut!(ref self, Access);
