...
pub impl ErrorImpl of ErrorTrait {
    ...
    fn message(self: Error) -> ByteArray {
        match self {
            ...
            Error::REWARDS_ISNT_U128 => "Rewards is too large, expected to fit in u128.",
            Error::BALANCE_ISNT_U128 => "Balance is too large, expected to fit in u128.",
            Error::COMMISSION_ISNT_U128 => "Commission is too large, expected to fit in u128.",
            ...
            Error::TOTAL_SUPPLY_NOT_U128 => "Total supply does not fit in u128.",
            ...
            Error::GLOBAL_INDEX_DIFF_NOT_U64 => "Global index diff does not fit in u64.",
