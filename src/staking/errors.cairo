...
impl DescribableError of Describable<Error> {
    fn describe(self: @Error) -> ByteArray {
        match self {
            ...
            Error::INVALID_COMMISSION_WITH_COMMITMENT => "Commission can be set below the maximum specified in the commission commitment",
            Error::INVALID_SAME_COMMISSION => "  Commission can't be set to the same value",
            Error::COMMISSION_COMMITMENT_EXPIRED => "Commission commitment has expired, can only decrease or set a new commitment",
            ...
            Error::STAKER_ALREADY_MIGRATED => "Staker is already migrated to latest version",
            ...
            Error::PEER_ID_SET_IN_PROGRESS => "Peer ID set is in progress",
            Error::PEER_ID_MUST_DIFFER => "Peer ID is already set to provided value",
            Error::INVALID_PEER_ID => "Peer ID is invalid",
            Error::PEER_ID_NOT_SET => "Peer ID is not set",
